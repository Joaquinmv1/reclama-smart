...
import camaraDeComercioimg from '../../../../assets/images/alliancesView/congreso reclamasmart 1.png';
      ...
      <section className={style.containerCamara}>
        <div className={style.allianceData}>
          ...
          <div className={style.camaraContent}>
            ...
            <article>Si desean ver el webinar o compartirlo con otros interesados, pueden encontrarlo en la página web de la AHK a través del siguiente enlace: <Link className={style.link} href={'https://peru.ahk.de/es/reviva-nuestros-eventos/ley-del-teletrabajo-y-los-cambios-de-esta-nueva-normativa-1'}>https://peru.ahk.de/es/reviva-nuestros-eventos/ley-del-teletrabajo-y-los-cambios-de-esta-nueva-normativa-1</Link>
            </article>
          </div>
        </div>
      </section>
