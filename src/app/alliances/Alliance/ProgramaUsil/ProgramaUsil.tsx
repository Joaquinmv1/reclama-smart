    ...
    <>
      <section className={style.containerUsil}>
        <div className={style.allianceData}>
          <TitleAlliance title="El Cliente" />
          ...
          <div className={style.usilContent}>
            ...
            <article>Aquí puede ver las declaraciones más importantes; el vídeo completo (Min. 26:56 - 37:48) puede verse <Link className={style.link} href={'https://www.youtube.com/watch?v=Ncw1yJ7q3mQ'} target="_blank">aquí.</Link></article>
          </div>
        </div>
      </section>
    </>
