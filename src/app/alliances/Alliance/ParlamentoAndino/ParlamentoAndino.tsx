      ...
      <section className={style.containerParlamento}>
        <div className={style.allianceData}>
          ...
          <div className={style.ParlamentoArticle}>
            ...
            <article>
              <Link className={style.link} href={'https://www.parlamentoandino.org.pe/derecho-al-olvido/'} target="_blank">https://www.parlamentoandino.org.pe/derecho-al-olvido/</Link>
            </article>
          </div>
        </div>
      </section>
