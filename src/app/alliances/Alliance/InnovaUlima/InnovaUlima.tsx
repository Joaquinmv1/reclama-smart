    ...
    <>
      <section className={style.containerInnovaUlima}>
        <div className={style.allianceData}>
          <TitleAlliance title="Innova Ulima" /> 
          ...
          <div className={style.innovaUlimaContent}>
            ...
            <article>
              <Link className={style.link} href={'https://www.ulima.edu.pe/departamento/centro-de-emprendimiento/concurso-de-emprendimiento-social'}>https://www.ulima.edu.pe/departamento/centro-de-emprendimiento/concurso-de-emprendimiento-social</Link>
            </article>
          </div>
        </div>
      </section>
