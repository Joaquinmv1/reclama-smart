      ...
      <section className={style.containerEntrepreneurial}>
        <div className={style.blogData}>
          ...
          <article className={style.entrepreneurialTexts}>
            ...
            <p>Recientemente, hemos llevado a cabo un <Link className={style.link} href={'/alliances?alliance=CamaraDeComercio'}>Webinar</Link> en colaboración con la AHK (Cámara de Comercio e Industria Peruano-Alemana), que exploró a fondo este tema (puedes ver la grabación <Link target='_blank' className={style.link} href={'https://peru.ahk.de/es/reviva-nuestros-eventos/ley-del-teletrabajo-y-los-cambios-de-esta-nueva-normativa-1'}>aquí</Link>). En nuestro próximo artículo, nos sumergiremos en los conceptos esenciales relacionados con la protección al consumidor y cómo las empresas pueden aplicar estas normativas de manera efectiva y detallada.</p>
