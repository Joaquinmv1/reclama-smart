    ...
    <>
      <section className={style.containerConsumer}>
        <div className={style.blogData}>
          ...
          <p className={style.fuente}> Fuente: <Link className={style.link} href={'https://www.consumidor.gob.pe/tus-derechos'}>https://www.consumidor.gob.pe/tus-derechos.</Link></p>
        </div>
      </section>
    </>
  )
