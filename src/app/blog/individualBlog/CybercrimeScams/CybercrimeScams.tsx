          ...
          <article className={style.fontsWeb}>
            <p>fuente: <br />
              <Link
                ...
                https://elcomercio.pe/lima/operadoras-trasladan-lineas-moviles-sin-el-consentimiento-de-los-usuarios-casos-suman-mas-de-10-millones-en-multas-noticia/?ref=ecr&fbclid=IwAR1nYmv-p23NsLeeueQpbdBxlCayRuh780I8UucdC2t_Q2fK3SeMUHnMG6c#google_vignette.
              </Link>
            </p>
            <p>fuente:<br />
              <Link
              ...
              href={' https://www.gob.pe/institucion/minjus/noticias/652966-minjusdh-presenta-estudio-sobre-ciberdelitos-en-el-pais-y-propone-recomendaciones-a-la-ciudadania'}>
                https://www.gob.pe/institucion/minjus/noticias/652966-minjusdh-presenta-estudio-sobre-ciberdelitos-en-el-pais-y-propone-recomendaciones-a-la-ciudadania.</Link>
            </p>
          </article>
        </div>
      </section>
